...
public class TeamMatch {
    ...
    @Generated(hash = 1033465309)
    private transient TeamMatchDao myDao;

    @Generated(hash = 1612659995)
    public TeamMatch(Long id, Long teamId, Long matchId) {
        this.id = id;
        this.teamId = teamId;
        this.matchId = matchId;
    }

    @Generated(hash = 228018383)
    public TeamMatch() {
    }
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1374607040)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getTeamMatchDao() : null;
    }
}
